...
{/*input number of beds*/}
            <div className="flex space-x-6 mb-6">
                <div>
                    ...
                    focus:border-slate-600 focus:bg-white text-center" 
                    />
                </div>
{/*input number of beds*/}
                <div>
...
{/*Parking availability*/}
            ...
            <div className="flex">
                ...
                uppercase shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg transition duration-150 ease-in-out w-full 
...
{/*Offer*/}             
            ...
            <div className="flex mb-6">
                ...
                value={true}
                onClick={onChange} 
                className={`rounded mr-3 px-7 py-3 font-medium text-sm uppercase
...
{/*CreateListing confirmation Button*/}
        <button
          type="submit"
          className="rounded-full mb-6 w-full px-7 py-3 bg-blue-600 text-white
